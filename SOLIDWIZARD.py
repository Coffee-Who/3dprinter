...
# =========================
# 初始化資料（重點：避免 KeyError）
# =========================
DEFAULT_CARDS = {
    "internal": [
        {"title": "CRM", "img": "https://images.unsplash.com/photo-1551288049-bebda4e38f71",
         "url": "http://192.168.100.85/WebCRM/src/_Common/AppUtil/FrameSet/NewLogin.aspx"},
        {"title": "EIP", "img": "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40",
         "url": "http://192.168.100.89/SWTCweb4.0/production/ADLoginPage.aspx"},
        {"title": "EASYFLOW", "img": "https://images.unsplash.com/photo-1551836022-d5d88e9218df",
         "url": "http://192.168.100.85/efnet/"},
        {"title": "請假系統", "img": "https://images.unsplash.com/photo-1508385082359-f38ae991e8f2",
         "url": "http://192.168.2.251/MotorWeb/CHIPage/Login.asp"},
    ],

    "official": [
        {"title": "實威官網", "img": "https://images.unsplash.com/photo-1522071820081-009f0129c71c",
         "url": "https://www.swtc.com/zh-tw/"},
        {"title": "YouTube", "img": "https://images.unsplash.com/photo-1611162616475-46b635cb6868",
         "url": "https://www.youtube.com/@solidwizard"},
        {"title": "智慧製造", "img": "https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5",
         "url": "https://www.youtube.com/@SWTCIM"},
        {"title": "知識+", "img": "https://images.unsplash.com/photo-1522202176988-66273c2fd55f",
    ...
    "formlabs": [
        ...
        {"title": "Support", "img": "https://images.unsplash.com/photo-1555949963-aa79dcee981c",
...
<div class='hero'>
<h1>實威國際數位入口</h1>
<p>Awwwards Style Portal</p>
</div>
""", unsafe_allow_html=True)

# =========================
# 安全 render（修正 KeyError重點🔥）
# =========================
def render(section):
    items = st.session_state.cards.get(section, [])  # ⭐ 防 KeyError
    ...
    for i, item in enumerate(items):
        with cols[i % 5]:
            ...
            if st.session_state.is_admin:
                ...
                with c1:
                    if st.button(f"編輯{i}-{section}"):
                        st.session_state.editing = (section, i)

                with c2:
                    if st.button(f"刪除{i}-{section}"):
